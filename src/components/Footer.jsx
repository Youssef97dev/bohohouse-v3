...
const Footer = () => {
  ...
  return (
    isClient && (
      <div className="w-full min-h-[16vh] bg-bgFooter flex flex-col justify-center items-center gap-3 pt-3 lg:pb-3 text-black text-[14px] leading-[30px] italic font-light">
        <span>@2025 Boho House</span>
