...
const Where = () => {
  return (
    <div className="w-full flex flex-col justify-center items-center  py-10 tracking-widest px-8 lg:px-[400px] lg:text-[16px] text-[16px] text-center gap-8">
      <h1 className="font-minionPro font-light text-[22px] leading-[33px]">{`Where we are`}</h1>
      <p className="font-light">{`A 45-minute drive from Marrakech, BOHO HOUSE is located near Lalla Takerkoust, offering scenic lake views and situated close to both the Agafay Desert and the spectacular Atlas Mountains.`}</p>
